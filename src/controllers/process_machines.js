...
module.exports = {
  create(req, res){
    let data = []
    if (((req.body.process_id != undefined) && (req.body.process_id.toString().length > 0)) && ((req.body.machine_id != undefined) && (req.body.machine_id.length > 0))) {
    ...
    return processMachine
      ...
      .then(processMachine => {
        resp.ok(true, "Success create product_category.", processMachine, res);
      })
      .catch((error) => {
